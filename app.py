...
if analyze_button:
    ...
    if not user_input.strip():
        ...
        is_spam = any(kw in user_input.lower() for kw in ["gagné", "urgent", "cliquez", "http", "banque", "prix"])
        ...
        with st.container():
            ...
            if is_spam:
                ...
                """, unsafe_allow_html=True)
                st.write("")
                st.metric(label="Niveau de risque", value="92 %", delta="Élevé", delta_color="inverse")
                ...
                """, unsafe_allow_html=True)
                st.write("")
                st.metric(label="Niveau de risque", value="8 %", delta="Faible", delta_color="normal")